...
public class BaiduMapActivity extends BaseSwipeBackActivity implements SensorEventListener {
    ...
    protected void initView() {
        //这是BaseActivity中检测网络的方法，true:开启检测状态
//        isOpenTestNet(true);
        // 地图初始化
        ...
        option.setScanSpan(750); //如果设置非0，需设置1000ms以上才有效?
    ...
    protected void onDestroy() {
        ...
        mMapView.onDestroy();
        super.onDestroy();
        //这是BaseActivity中检测网络的方法，true:关闭检测状态
//        isOpenTestNet(false);
    }
    @Override
