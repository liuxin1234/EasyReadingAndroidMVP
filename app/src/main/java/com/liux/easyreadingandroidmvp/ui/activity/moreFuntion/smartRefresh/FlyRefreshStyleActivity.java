...
import com.liux.easyreadingandroidmvp.utils.StatusBarUtil;
...
public class FlyRefreshStyleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fly_refresh_style);
...
//        StatusBarUtil.setPaddingSmart(this, findViewById(R.id.blurview));
    ...
    private class ItemAdapter extends RecyclerView.Adapter<ItemViewHolder> {
        ...
        public ItemViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View view = mInflater.inflate(R.layout.list_item_fly_refresh, viewGroup, false);
