...
public class SslContextFactory {
    ...
    private static final String CLIENT_TRUST_KEYSTORE = "BKS"; //证书类型 固定值
    private static final String CLIENT_TRUST_PROVIDER = "BC";
    //以下双向认证时候用到  一般是银行，金融类高安全型的app应用。
    private static final String CLIENT_TRUST_KEY = "PKCS12"; //证书类型 固定值
    public static String TRUST_CA_PWD = "Huawei@123"; //服务器端CA认证密码
    public static String SELF_CERT_PWD = "IoM@1234";  //客户端自身认证密码
