...
import com.liux.module.itemMenuBean.LeftItemMenu;
...
public class MenuDataUtils {
    public static List<LeftItemMenu> getItemMenus(){
        ...
        menus.add(new LeftItemMenu(R.drawable.icon_guanzhu,"我的关注"));
        ...
        menus.add(new LeftItemMenu(R.drawable.icon_about_we,"关于我们"));
        menus.add(new LeftItemMenu(R.drawable.icon_tuichu,"退出登录"));
        return  menus;
    }
